...
* [🚢 Deploy a beta](./Deployment/Beta.md)
* [🚀 Release the app](./Deployment/Release.md)
* [📈 Check the latest release is working](./Deployment/CheckLatestRelease.md)

## Utilities
* [🤖 Create a UI test](./Utilities/CreateUITest.md)
* [👤 Create test accounts](./Utilities/CreateTestAccounts.md)
* [🚗 Test the ride flow](./Utilities/TestRideFlow.md)
* [📱 Prepare for a demo](./Utilities/PrepareForDemo.md)
* [💳 Use fake cards](./Utilities/UseFakeCards.md)
* [📡 Check what the backend is sending me](./Utilities/CheckBackend.md)
* [🕵️‍♂️ Debug my UI](./Utilities/DebugUI.md)
* [🚩 Hide my feature behind a feature flag](./Utilities/FeatureFlag.md)
* [➡️ Add a new deeplink](./Utilities/AddDeeplink.md)
